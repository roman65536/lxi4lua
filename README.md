This a stand alone "copy" for LUA of [liblxi](https://github.com/lxi-tools/liblxi) and [lxi-tools](https://github.com/lxi-tools/lxi-tools). 
[lxi-tools](https://github.com/lxi-tools/lxi-tools) is a great thing, however it can't be used in cli lua or when lua is embedded such as in lualatex. 
